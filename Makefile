...
LDFLAGS= -lm
SOURCES=$(SRCDIR)/common.c $(SRCDIR)/time.c $(SRCDIR)/log.c $(SRCDIR)/zmalloc.c $(SRCDIR)/arc4random.c $(SRCDIR)/strlcpy.c $(SRCDIR)/strlcat.c $(SRCDIR)/itoa.c $(SRCDIR)/strdup.c $(SRCDIR)/stresc.c $(SRCDIR)/quid.c $(SRCDIR)/sha1.c \
